...
image_icon = PhotoImage(file="clock_icon.png")
root.iconphoto(False, image_icon)

Top = PhotoImage(file="top_clock.png")
Label(root, image=Top, bg="#1a212d").pack()

Main = PhotoImage(file="clock_speed.png")
Label(root, image=Main, bg="#1a212d").pack(pady=(40, 0))

button = PhotoImage(file="start_button.png")
Button(root, image=button, bg="#1a212d", bd=0, activebackground="#1a212d", cursor="hand2", command=Check).pack(pady=(10))

Label(root, text="PING", font="arial 10 bold", bg="#384056").place(x=50, y=0)
Label(root, text="DOWLOAD", font="arial 10 bold", bg="#384056").place(x=140, y=0)
